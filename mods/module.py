...
def genCont():
    ...
    prompt = '''Generate me a blog post about a random coding tutorial people or coders usually search about,markdown format and make it as long as possible and do not take this as a chat plus dont put the markdown in a codeblock just return plain html and use  as codeblocks instead of code tags'''
